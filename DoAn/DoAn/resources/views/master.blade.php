...
<head>
	...
	<link rel="stylesheet" href="{{URL::to('admin-asset/bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
...
@yield('content')
	...
	<script src="{{URL::to('source/assets/dest/js/bootstrap.min.js')}}"></script>
